...
namespace Engine
{
    public static class World
    {
        ...
        public const int QUEST_ID_CLEAR_FARMERS_FILED = 2;
        ...
        private static void PopulateLocations()
        {
            ...
            Location alchemistHut = new Location(LOCATION_ID_ALCHEMIST_HUT,
                "Alchemist's hut", "There are many strange plants on the shelf.");
            ...
            farmhouse.QuestAvailableHere = QuestById(QUEST_ID_CLEAR_FARMERS_FILED);
            ...
            // Link all the locations together
        ...
        private static void PopulateQuests()
        {
            Quest clearAlchemistGarden = new Quest(QUEST_ID_CLEAR_ALCHEMIST_GARDEN,
                ...
                "Kill rats in the alchemist's garden and brign back 3 rat tails." +
            ...
            Quest clearFarmersField = new Quest(QUEST_ID_CLEAR_FARMERS_FILED,
                "Clear the farmer's field.",
                "Kill the snakes in the farmer's field and brign back 3 snake fangs." +
        ...
        private static void PopulateItems()
        {
            ...
            Items.Add(new Item(ITEM_ID_SNAKE_FANG, "Sanke fang", "Snake fangs"));
